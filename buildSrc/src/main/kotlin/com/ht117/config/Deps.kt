...
object Deps {
    ...
    object Network {
        const val serialization = "org.jetbrains.kotlinx:kotlinx-serialization-core:1.7.20"
        const val ktorCore = "io.ktor:ktor-client-core:2.1.3"
        const val ktorOkhttp = "io.ktor:ktor-client-okhttp:2.1.3"
        const val serializeJson = "org.jetbrains.kotlinx:kotlinx-serialization-json:1.4.1"
